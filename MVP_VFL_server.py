...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', '--trainPath', dest='trainPath', help='Path to .csv with train dataset', type=str, default=r"data/insurance_train.csv")
    parser.add_argument('-v', '--validPath', dest='validPath', help='Path to .csv with valid dataset', type=str, default=r"data/insurance_test.csv")
